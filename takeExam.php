   ...
   <body>
       ...
       <main style="display:none">
         <form id="hidden_form" method="POST" action="server.php" target="displayed_exam_container">
            <input text="text" id="Exam_type_controller4takeExam" name="Exam_type_controller4takeExam" ><br>
            <input text="text" id="subject_type_controller4takeExam" name="subject_type_controller4takeExam" ><br>
            <input text="submit" name="submit_hidden_form" value="submit">
         </form> 
       </main>
       ...
       <iframe  name="displayed_exam_container" style="float:right;width:84%;height:388px;border-width: 0;overflow:auto"></iframe>
        ...
        <script>
            function showExam(x,y){
                document.getElementById("Exam_type_controller4takeExam").value=x;
                document.getElementById("subject_type_controller4takeExam").value=y;
